...
import com.hackaton.hackback.email.EmailSender;
import com.hackaton.hackback.security.UserDetailsServiceImpl;
import com.hackaton.hackback.security.jwt.JwtResponse;
import com.hackaton.hackback.security.jwt.JwtUtils;
import com.hackaton.hackback.security.jwt.MessageResponse;
import com.hackaton.hackback.security.token.ConfirmationToken;
...
//        customerRepository.save(customer);
    ...
    @Transactional
    public ResponseEntity<?> confirmToken(String token) throws URISyntaxException {
        ...
        userDetails.enableAppUser(
                confirmationToken.getAppUser().getEmail());
        URI yahoo = new URI("http://localhost:3000/confirmation");
